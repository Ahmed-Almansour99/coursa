              ...
              Center(
                child: Padding(
                  padding: EdgeInsets.symmetric(
                    vertical: context.getHeight(per: 0.39),
                  ),
                  child: Image.asset(
                    'assets/images/earth.png',
                    fit: BoxFit.fill,
                    width: context.getWidth(per: 4.8),
                    height: context.getHeight(per: 2.4),
                  ),
                ),
              ),
              Padding(
                padding: EdgeInsets.symmetric(
                  horizontal: context.getWidth(per: 0.4),
                ),
                child: Container(
                  width: context.getWidth(),
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.all(
                      Radius.circular(context.getWidth(per: 2)),
                    ),
                  ...
                  child: Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.symmetric(
                          vertical: context.getHeight(per: 0.5),
                        ),
                        child: Text(
                          context.locale.languageCode == 'ar'
                              ? AppText.chooseLanguage2
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: Padding(
                              padding: EdgeInsets.symmetric(
                                horizontal: context.getWidth(per: 0.50),
                                vertical: context.getHeight(per: 0.5),
                              ),
